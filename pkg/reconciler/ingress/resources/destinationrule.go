...
// on for the specified IngressBackendSplit
func MakeInternalEncryptionDestinationRule(ing *v1alpha1.Ingress, split v1alpha1.IngressBackendSplit, http2 bool) *v1alpha3.DestinationRule {
